...
namespace TripFlip.DataAccess.Migrations
{
    ...
    [Migration("20200905183458_Add-Trip-Role-Management-Entities")]
    partial class AddTripRoleManagementEntities
    {
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.ItemListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 21, 34, 56, 690, DateTimeKind.Unspecified).AddTicks(8449), new TimeSpan(0, 3, 0, 0, 0)),
                            RouteId = 1,
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.RouteEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 21, 34, 56, 689, DateTimeKind.Unspecified).AddTicks(8449), new TimeSpan(0, 3, 0, 0, 0)),
                            Title = "First route",
                            TripId = 1
                        },
                        new
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TaskEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 21, 34, 56, 691, DateTimeKind.Unspecified).AddTicks(8450), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TripEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 21, 34, 56, 683, DateTimeKind.Unspecified).AddTicks(8445), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f7b70c34-27d3-4e9a-b64c-5fb0bad49ee9"),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 21, 34, 56, 691, DateTimeKind.Unspecified).AddTicks(8450), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("8bcc1e77-d183-41c9-8210-038d00ab12e4"),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 21, 34, 56, 691, DateTimeKind.Unspecified).AddTicks(8450), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("6c919abc-5845-49e1-ab97-8bad7b19b154"),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 21, 34, 56, 691, DateTimeKind.Unspecified).AddTicks(8450), new TimeSpan(0, 3, 0, 0, 0)),
