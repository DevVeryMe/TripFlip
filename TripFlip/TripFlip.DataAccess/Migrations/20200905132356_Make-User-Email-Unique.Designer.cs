...
namespace TripFlip.DataAccess.Migrations
{
    ...
    [Migration("20200905132356_Make-User-Email-Unique")]
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.ItemListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 16, 23, 54, 691, DateTimeKind.Unspecified).AddTicks(4396), new TimeSpan(0, 3, 0, 0, 0)),
                            RouteId = 1,
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.RouteEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 16, 23, 54, 690, DateTimeKind.Unspecified).AddTicks(4396), new TimeSpan(0, 3, 0, 0, 0)),
                            Title = "First route",
                            TripId = 1
                        },
                        new
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TaskEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 16, 23, 54, 692, DateTimeKind.Unspecified).AddTicks(4397), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TripEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 16, 23, 54, 684, DateTimeKind.Unspecified).AddTicks(4392), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("21ccc963-025b-46d5-bae0-421ea1258a69"),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 16, 23, 54, 692, DateTimeKind.Unspecified).AddTicks(4397), new TimeSpan(0, 3, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("4c767643-f0eb-4c27-a646-bdffd34619bb"),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 16, 23, 54, 693, DateTimeKind.Unspecified).AddTicks(4397), new TimeSpan(0, 3, 0, 0, 0)),
                            Email = "sample2.email@mail.com",
                            PasswordHash = "some_other_hash"
                        },
                        new
                        {
                            Id = new Guid("743ad20d-d566-4761-8c1c-4167ad7a290e"),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 5, 16, 23, 54, 693, DateTimeKind.Unspecified).AddTicks(4397), new TimeSpan(0, 3, 0, 0, 0)),
