...
namespace TripFlip.DataAccess.Migrations
{
    ...
    [Migration("20200918151440_AddTaskAssigneeEntity")]
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TaskListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 18, 18, 14, 39, 383, DateTimeKind.Unspecified).AddTicks(4411), new TimeSpan(0, 3, 0, 0, 0)),
                            RouteId = 1,
                            Title = "Tasks"
                        });
                });
