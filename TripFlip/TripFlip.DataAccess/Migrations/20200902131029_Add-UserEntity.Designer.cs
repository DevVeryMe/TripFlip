...
namespace TripFlip.DataAccess.Migrations
{
    ...
    [Migration("20200902131029_Add-UserEntity")]
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.ItemListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 2, 16, 10, 28, 625, DateTimeKind.Unspecified).AddTicks(935), new TimeSpan(0, 3, 0, 0, 0)),
                            RouteId = 1,
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.RouteEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 2, 16, 10, 28, 624, DateTimeKind.Unspecified).AddTicks(934), new TimeSpan(0, 3, 0, 0, 0)),
                            Title = "First route",
                            TripId = 1
                        },
                        new
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TaskEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 2, 16, 10, 28, 626, DateTimeKind.Unspecified).AddTicks(935), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TripEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 2, 16, 10, 28, 617, DateTimeKind.Unspecified).AddTicks(930), new TimeSpan(0, 3, 0, 0, 0)),
