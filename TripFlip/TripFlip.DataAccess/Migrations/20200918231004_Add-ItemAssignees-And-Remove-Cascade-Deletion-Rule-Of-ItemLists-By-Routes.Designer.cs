...
namespace TripFlip.DataAccess.Migrations
{
    ...
    [Migration("20200918231004_Add-ItemAssignees-And-Remove-Cascade-Deletion-Rule-Of-ItemLists-By-Routes")]
    partial class AddItemAssigneesAndRemoveCascadeDeletionRuleOfItemListsByRoutes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.ItemAssigneeEntity", b =>
                {
                    ...
                    b.HasKey("ItemId", "RouteSubscriberId");
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.ItemListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 8, 17, 14, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            RouteId = 1,
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.TaskListEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTimeOffset(new DateTime(2020, 9, 19, 2, 10, 2, 689, DateTimeKind.Unspecified).AddTicks(8921), new TimeSpan(0, 3, 0, 0, 0)),
                            RouteId = 1,
                            Title = "Tasks"
                        });
                });
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AboutMe = "About me",
                            BirthDate = new DateTimeOffset(new DateTime(2020, 8, 17, 14, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 8, 17, 14, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("TripFlip.Domain.Entities.ItemAssigneeEntity", b =>
                {
                    b.HasOne("TripFlip.Domain.Entities.ItemEntity", "Item")
