...
namespace WebApiUnitTests.ItemViewModels
{
    ...
    public class UpdateItemViewModelPositiveTests
    {
        ...
        private static IEnumerable<object[]> GetUpdateItemViewModelData()
        {
            ...
            {
                "Test case 1: Create_UpdateItemViewModel_Given_Valid_Not_null_values_Should_be_successful",
                GetUpdateItemViewModel(1, "Tent", null, null,true)
            };

            yield return new object[]
            {
                "Test case 1: Create_UpdateItemViewModel_Given_Valid_With_null_values_where_possible_Should_be_successful",
